...
<link href="../css/aboutBuy/beOnDelivery.css" type="text/css" rel="stylesheet" />
</head>
<body>
	<header id ="header">
				...
				<table id="auction-table">
					...
					<tbody>
						<tr>
							...
							<td>
								<input type="submit" value="배송조회" name="search-delivery">
								<input type="submit" value="작품수령확인" name="check-receipt">
							</td>
						</tr>
					</tbody>
				</table>
